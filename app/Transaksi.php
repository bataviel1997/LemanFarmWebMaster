...
class Transaksi extends Model
{
    ...
    public function details(){
        return $this->hasMany(TransaksiDetail::class, "transaksi_id", "id");   // transaksi yang memuliki banyak relasi dgn
    }

    public function user(){
        return $this->belongsTo(User::class, "user_id", "id");  // transaksi relasi milik user
    }
}